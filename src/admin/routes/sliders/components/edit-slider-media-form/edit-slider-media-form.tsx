...
import { KeyboundForm } from "../../../../components/common/utilities/keybound-form";
//import { useUpdateProduct } from "../../../../../hooks/api/products";

import { sdk } from "../../../../lib/config";
import { EditProductMediaSchema } from "../constants";
import { MediaSchema } from "../constants";
import { EditProductMediaSchemaType, Slider } from "../types";
...
export const EditSliderMediaForm = ({ sliders }: ProductMediaViewProps) => {
  ...
  const { mutateAsync, isPending } = useUpdateSlider();
